...
export function PlayerView({ metadata, audioUrl, theme, lyrics, onBack }: PlayerViewProps) {
  ...
  useEffect(() => {
    ...
    if (lang) {
      ...
      else if (lang === 'Tamil')     setTranslateTarget('tanglish');
      else if (lang === 'Malayalam') setTranslateTarget('manglish');
      else if (lang === 'Telugu')    setTranslateTarget('tenglish');
      else if (lang === 'Kannada')   setTranslateTarget('kanglish');
      else if (lang === 'Bengali')   setTranslateTarget('banglish');
      else if (lang === 'Punjabi')   setTranslateTarget('punglish');
      else if (lang === 'Arabic')    setTranslateTarget('arablish');
      else if (lang === 'Japanese')  setTranslateTarget('japanglish');
      else                           setTranslateTarget('hinglish');
